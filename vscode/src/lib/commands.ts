    ...
    entries: [
      ...
      { id: 'history', label: 'Run History', detail: 'Recent sfdt runs (audit, monitor, quality, test, deploy) from the local index', args: ['history'], icon: 'history', noOrg: true },
      {
        ...
        children: [
          ...
          { id: 'audit-api-versions', label: 'API Versions', detail: 'Deprecated API versions + org ceiling (Apex, triggers, Flows, LWC, Aura)', args: ['audit', 'api-versions'], refreshes: 'audit' },
    ...
    entries: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'ci-init-github-release', label: 'GitHub · Release', detail: 'Approval-gated release deploy workflow for GitHub Actions', args: ['ci', 'init', '--provider', 'github', '--type', 'release'] },
          { id: 'ci-init-gitlab-release', label: 'GitLab · Release', detail: 'Manual, environment-bound release deploy job for GitLab CI', args: ['ci', 'init', '--provider', 'gitlab', '--type', 'release'] },
          { id: 'ci-init-azure-release', label: 'Azure · Release', detail: 'Environment-gated release deploy pipeline for Azure DevOps', args: ['ci', 'init', '--provider', 'azure', '--type', 'release'] },
          { id: 'ci-init-bitbucket-release', label: 'Bitbucket · Release', detail: 'Release deploy pipeline bound to a deployment environment for Bitbucket Pipelines', args: ['ci', 'init', '--provider', 'bitbucket', '--type', 'release'] },
          { id: 'ci-init-github-scratch', label: 'GitHub · Scratch CI', detail: 'PR scratch-org create/deploy/test/delete workflow for GitHub Actions', args: ['ci', 'init', '--provider', 'github', '--type', 'scratch'] },
          { id: 'ci-init-gitlab-scratch', label: 'GitLab · Scratch CI', detail: 'MR scratch-org create/deploy/test/delete job for GitLab CI', args: ['ci', 'init', '--provider', 'gitlab', '--type', 'scratch'] },
          { id: 'ci-init-azure-scratch', label: 'Azure · Scratch CI', detail: 'PR scratch-org create/deploy/test/delete pipeline for Azure DevOps', args: ['ci', 'init', '--provider', 'azure', '--type', 'scratch'] },
          { id: 'ci-init-bitbucket-scratch', label: 'Bitbucket · Scratch CI', detail: 'PR scratch-org create/deploy/test/delete pipeline for Bitbucket Pipelines', args: ['ci', 'init', '--provider', 'bitbucket', '--type', 'scratch'] },
        ],
      },
