...
log_info "Analyzing test quality for ${
...
calculate_quality_score() {
    ...
    quality_score=$((quality_score - total_issues * 5))
    quality_score=$((quality_score - total_recommendations))
...
main() {
    ...
    echo "Total Test Classes: ${
    echo "Total Apex Classes: ${
    echo "Quality Issues: ${
